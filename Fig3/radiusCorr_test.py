...
x1_0, y1_0 = np.loadtxt('V5_M1_omega0.5_gamma10_t2_radicorr.txt', unpack=True)
x2_0, y2_0 = np.loadtxt('V25_M1_omega0.5_gamma10_t2_radicorr.txt', unpack=True)
#x3_0, y3_0 = np.loadtxt('V45_M1_omega0.5_gamma10_t2_radicorr.txt', unpack=True)
x4_0, y4_0 = np.loadtxt('V65_M1_omega0.5_gamma10_t2_radicorr.txt', unpack=True)

x0_1, y0_1, yerr0_1, z0_1, zerr0_1 = np.loadtxt('timescale_omega0.1.txt', unpack=True)
x0_2, y0_2, yerr0_2, z0_2, zerr0_2 = np.loadtxt('timescale_omega0.5.txt', unpack=True)
x0_3, y0_3, yerr0_3, z0_3, zerr0_3 = np.loadtxt('timescale_omega0.9.txt', unpack=True)
...
axs[0].plot(x4_0 * 0.0009 / tau, y4_0, label=r"\boldmath$Pe=16.2\times10^5$", color='green', lw=2)
#axs[0].plot(x3_0 * 0.0009 / tau, y3_0, label=r"\boldmath$Pe=11.2\times10^5$", color='orange', lw=2)
axs[0].plot(x2_0 * 0.0009 / tau, y2_0, label=r"\boldmath$Pe=6\times10^5$", color='red', lw=2)
axs[0].plot(x1_0 * 0.0009 / tau, y1_0, label=r"\boldmath$Pe=1.2\times10^5$", color='darkblue', lw=2)
...
axs[1].errorbar(x0_3 * scale, y0_3, yerr=yerr0_3, fmt='D',  capsize=4,markersize = 10, color='red', label=r"\boldmath$\Omega=0.9$")
axs[1].errorbar(x0_2 * scale, y0_2, yerr=yerr0_2, fmt='s',  capsize=4,markersize = 10, color='darkblue',label=r"\boldmath$\Omega=0.5$")
axs[1].errorbar(x0_1 * scale, y0_1, yerr=yerr0_1, fmt='o', capsize=4,markersize = 10, color='darkgreen', label=r"\boldmath$\Omega=0.1$")
...
axs[1].text(-0.08, 1.02, r'\boldmath$(\times 10^{-4})$', transform=axs[1].transAxes, fontsize=20, fontweight='bold')

axs[2].errorbar(x0_3 * scale, z0_3, yerr=zerr0_3, fmt='D', capsize=4,markersize = 10, color='red',label=r"\boldmath$\Omega=0.9$")
axs[2].errorbar(x0_2 * scale, z0_2, yerr=zerr0_2, fmt='s',  capsize=4,markersize = 10, color='darkblue',label=r"\boldmath$\Omega=0.5$")
axs[2].errorbar(x0_1 * scale, z0_1, yerr=zerr0_1, fmt='o',  markersize = 10,capsize=4, color='darkgreen',label=r"\boldmath$\Omega=0.1$")
...
axs[1].plot(x1s, spline1(x1s), linestyle=':', linewidth=2, color='darkgreen')
axs[1].plot(x2s, spline2(x2s), linestyle=':', linewidth=2, color='darkblue')
axs[1].plot(x3s, spline3(x3s), linestyle=':', linewidth=2, color='red')
...
axs[2].plot(x3s, spline6(x3s), linestyle=':', linewidth=1.8, color='red')
axs[2].plot(x2s, spline5(x2s), linestyle=':', linewidth=1.8, color='darkblue')
axs[2].plot(x1s, spline4(x1s), linestyle=':', linewidth=1.8, color='darkgreen')
...
axs[2].text(0.90, -0.08, r'\boldmath$(\times 10^6)$', transform=axs[2].transAxes, fontsize=16, fontweight='bold')
...
axs[2].text(-0.08, 1.02, r'\boldmath$(\times 10^{4})$', transform=axs[2].transAxes, fontsize=20, fontweight='bold')
...
plt.tight_layout()
plt.savefig('decayTime_radiusCorr_M1_gamma10.pdf')
plt.close()
