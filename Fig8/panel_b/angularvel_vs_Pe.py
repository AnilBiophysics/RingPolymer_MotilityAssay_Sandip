...
x0_1, y0_1, error_1 = np.loadtxt('angularVel_M1_gamma10_t2_omega0.1.txt', unpack=True)
x0_2, y0_2, error_2 = np.loadtxt('angularVel_M1_gamma10_t2_omega0.5.txt', unpack=True)
x0_3, y0_3, error_3 = np.loadtxt('angularVel_M1_gamma10_t2_omega0.9.txt', unpack=True)
...
ax.errorbar(x0_3* scale, y0_3, yerr=error_3/np.sqrt(20), fmt='D', color='green', markersize=10, capsize=4, linewidth=2, label=r"\boldmath$\Omega=0.9$")
ax.errorbar(x0_2* scale, y0_2, yerr=error_2/np.sqrt(20), fmt='s', color='red', markersize=10, capsize=4, linewidth=2, label=r"\boldmath$\Omega=0.5$")
ax.errorbar(x0_1* scale, y0_1, yerr=error_1/np.sqrt(20), fmt='o', color='blue', markersize=10, capsize=4, linewidth=2, label=r"\boldmath$\Omega=0.1$")
...
ax.set_yticklabels([r'\boldmath$0$', r'\boldmath$1000$', r'\boldmath$2000$',r'\boldmath$3000$',r'\boldmath$4000$',r'\boldmath$5000$',r'\boldmath$6000$',r'\boldmath$7000$',r'\boldmath$8000$'], fontsize=18)
...
#plt.ylim(0.05,0.25)
plt.tight_layout()
plt.savefig('angularVel_vs_pe_M1_gamma10_varyOmega.pdf')
